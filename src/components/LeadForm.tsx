...
const LeadForm: React.FC<LeadFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      const response = await fetch("https://formspree.io/f/xblyjjkp", {
        method: "POST",
          ...
          <>
            ...
            >
              <motion.div variants={itemVariants}>
                <Input name="name" placeholder="Your Full Name" value={formData.name} onChange={handleChange} error={errors.name} required />
              </motion.div>
              <motion.div variants={itemVariants}>
                <Input name="phone" placeholder="Phone Number" value={formData.phone} onChange={handleChange} error={errors.phone} required />
              </motion.div>
              <motion.div variants={itemVariants}>
              ...
              <motion.div variants={itemVariants}>
                <Input name="address" placeholder="Property Address" value={formData.address} onChange={handleChange} error={errors.address} required />
              </motion.div>
              {!compact && (
                <motion.div variants={itemVariants}>
                  <textarea
              ...
              <motion.p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-4" variants={itemVariants}>
